...
specialization: triangles / vectors / minimal systems
...
status: probably redesigning something that was fine already
```
...
music:
  - metalhead
  - extreme metal (thrash / black / death / doom)
  - progressive metal

games:
  - roguelikes
  - anything with procedural chaos

other:
  - designing things
  - discussing ideas
  - talking with people about projects / music / games

  - add me on stats.fm if you wanna talk about music and stuff
  - stats.fm/absolutenowhere
...
"why is a cybersecurity student making logos and icons?"

my answer:
good question. mind your own business.
also, no reason not to.

you see the pinned repositories on this profile?
...
```text
i work with a group called antixerox. name also made by me.
nothing against the brand, just an inner joke of a vulnerability we found.

we're basically a bunch of cybersecurity students who like building things,
breaking things, and experimenting with ideas. sometimes those ideas turn
into projects, sometimes they just turn into chaos.

you know those black and white triangular profile pictures of the dudes i work with?
...
```text
most of the icons and visual stuff around our projects follow the same
triangle / vector style system i made for the team.
```
...
```text
you won't catch me making my own repository, i rarely create them myself.
...
- create icon systems
- keep everything organized (kinda)
- create names
- structure ideas
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,python,figma,git,linux,vscode" />
</p>
